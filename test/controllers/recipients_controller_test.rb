...
class RecipientsControllerTest < ActionController::TestCase
  ...
  test "should create recipient" do
    assert_difference('Recipient.count') do
      post :create, recipient: { name: @recipient.name, postcode: @recipient.postcode, relationship: @recipient.relationship, state: @recipient.state, street_address: @recipient.street_address, suburb: @recipient.suburb, user_id: @recipient.user_id }
    end
  ...
  test "should update recipient" do
    patch :update, id: @recipient, recipient: { name: @recipient.name, postcode: @recipient.postcode, relationship: @recipient.relationship, state: @recipient.state, street_address: @recipient.street_address, suburb: @recipient.suburb, user_id: @recipient.user_id }
    assert_redirected_to recipient_path(assigns(:recipient))
  end
