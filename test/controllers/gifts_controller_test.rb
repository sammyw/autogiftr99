...
class GiftsControllerTest < ActionController::TestCase
  ...
  test "should create gift" do
    assert_difference('Gift.count') do
      post :create, gift: { description: @gift.description, image: @gift.image, name: @gift.name, price: @gift.price }
    end
  ...
  test "should update gift" do
    patch :update, id: @gift, gift: { description: @gift.description, image: @gift.image, name: @gift.name, price: @gift.price }
    assert_redirected_to gift_path(assigns(:gift))
  end
