...
class OccasionsControllerTest < ActionController::TestCase
  ...
  test "should create occasion" do
    assert_difference('Occasion.count') do
      post :create, occasion: { date: @occasion.date, description: @occasion.description, message: @occasion.message, occasion_type: @occasion.occasion_type, recipient_id: @occasion.recipient_id }
    end
  ...
  test "should update occasion" do
    patch :update, id: @occasion, occasion: { date: @occasion.date, description: @occasion.description, message: @occasion.message, occasion_type: @occasion.occasion_type, recipient_id: @occasion.recipient_id }
    assert_redirected_to occasion_path(assigns(:occasion))
  end
